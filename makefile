...
SOURCE1 = main_search_clustering.cpp ParametersFileReader.cpp NearestNeighbourSolver.cpp InnerProductCalculator.cpp Logger.cpp HashTableCurve.cpp HashTableCube.cpp HashTable.cpp HashFunctionH.cpp HashFunctionG.cpp HashFunctionF.cpp HashFunctionCalculator.cpp Grid.cpp Generator.cpp FileReader.cpp DistanceCalculator.cpp DataSet.cpp DataLine.cpp DataCurve.cpp CommandLineParser.cpp ClusteringSolver.cpp 
